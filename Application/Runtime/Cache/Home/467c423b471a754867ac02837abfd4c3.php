...
<div class="header" style="z-index:5;">
    ...
    <div class="middle_t site_20">我的积分</div>
    <div class="right_t">
...
<div class="content_normal">
    ...
    <div class="weui_panel">
        <div class="weui_panel_hd">当前积分：<span style="color: orangered"><?php echo ($corn); ?></span></div>
        <?php if(is_array($corn_list)): $i = 0; $__LIST__ = $corn_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="weui_panel_bd">
            <div class="weui_media_box weui_media_text">
                ...
                <ul class="weui_media_info">
                    <li class="weui_media_info_meta">归还日期:<?php echo ($vo["back_real_time"]); ?></li>
                    <li class="weui_media_info_meta"></li>
                    <li class="weui_media_info_meta weui_media_info_meta_extra"><span style="color: orange">积分+100</span></li>
                </ul>
            </div>
            ...
            <div class="weui_panel weui_panel_access">
                <div class="weui_panel_bd">
                    <?php if(is_array($fa_list)): $i = 0; $__LIST__ = $fa_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="javascript:void(0);" class="weui_media_box weui_media_appmsg" onclick="go_detail('<?php echo ($vo[book_detail][ISBN]); ?>')">
                        ...
                        <div class="weui_media_bd " >
                            <h4 class="weui_media_title"><?php echo ($vo[book_detail][book_name]); ?></h4>
                            <p class="weui_media_desc"><?php echo ($vo[book_detail][book_content]); ?></p>
                            <p class="weui_media_desc" style="color: orange">收藏时间：<?php echo ($vo["addtime"]); ?></p>
                        </div>
